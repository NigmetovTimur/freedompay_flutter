...
> **Примечание:** после миграции на FreedomPay Merchant/Payment SDK полный обзор всех доступных Flutter-методов (параметры, ожидаемые ответы и поддержка на Android/iOS) приведён в [docs/flutter_payment_flows.md](docs/flutter_payment_flows.md).
